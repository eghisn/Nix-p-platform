...
const baseProduct = {
  ...
  mediaCondition: "Near Mint - Light surface noise between tracks",
  sleeveCondition: "Very Good - Sleeve has a small tear",
  mediaConditionGrade: "Near Mint",
  mediaConditionNote: "Light surface noise between tracks",
  sleeveConditionGrade: "Very Good",
  sleeveConditionNote: "Sleeve has a small tear",
  year: 2026,
  label: "Test Label",
...
for (const [field, value] of [
  ...
  ["mediaConditionGrade", "Very Good"],
  ["sleeveConditionNote", "Spine wear"],
